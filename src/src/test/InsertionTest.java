...
class InsertionTest {
    ...
    @Test
    public void test1_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test2_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test3_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test4_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test5_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test6_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test7_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test8_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test9_insertion() throws IOException, InterruptedException {
    ...
    @Test
    public void test10_insertion() throws IOException, InterruptedException {
        int [] answer={1,2,8,1,7,5,6,4,88,99,10,55,3,6,4,8,5,6,9,74,122};
        Insertion I=new Insertion();
        int [][]an=I.sort(answer,true);

        assertEquals("Testing manual Insertion", answer[0], 1);
        assertEquals("Testing manual Insertion", answer[20], 122);
    }
